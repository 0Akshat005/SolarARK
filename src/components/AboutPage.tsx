...
export const AboutPage: React.FC<AboutPageProps> = ({
  ...
  return (
    <div className="pt-20 lg:pt-24 pb-6 min-h-screen bg-[#FCFAF7] text-slate-900 selection:bg-[#8B1E1E] selection:text-white">
      
      {/* ── REUSABLE INNER-PAGE TOP CONTEXT BAR (NO CARD, NO BOX, INLINE ACTION) ── */}
      <PageContextBar
        currentPage="About Us"
        onNavigate={onNavigate}
      />

      <div className="max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-12 space-y-16 sm:space-y-24">
