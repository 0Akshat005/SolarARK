  ...
  return (
    <div className="min-h-screen bg-[#FAF9F6] text-slate-900 selection:bg-[#8B1E1E] selection:text-white pt-24 pb-20">
      ...
      <section className="max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-12 mb-16">
        <div className="bg-[#120808] text-white rounded-3xl p-6 sm:p-8 lg:p-10 shadow-xl border border-[#8B1E1E]/30 relative overflow-hidden space-y-6">
          ...
          <div className="relative z-10 flex items-center justify-between border-b border-white/10 pb-4">
            ...
            <span className="text-xs text-amber-300 font-bold font-heading hidden sm:inline">
              3 Featured Reels
            </span>
          </div>
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-8 space-y-3">
              ...
              <p className="text-xs sm:text-sm text-slate-200 max-w-2xl leading-relaxed">
                Connect with our team to know about upcoming trade fairs, property expos, and local solar awareness workshops in your city.
              </p>
            </div>
            ...
            <div className="lg:col-span-4 flex flex-col gap-3">
              ...
              >
                ...
                <span>Direct Helpline: <strong>+91 7080909590</strong></span>
              </a>
            </div>
          </div>
