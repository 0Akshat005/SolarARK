...
export const Footer: React.FC<FooterProps> = ({ onCtaClick, onNavigate }) => {
  ...
  return (
    <footer className="bg-[#151817] text-[#9E9E99] text-sm border-t border-stone-800/80 pb-20 lg:pb-0">
      
      {/* Compact Closing Trust Echo Banner */}
      <div className="bg-[#1C201F] border-b border-stone-800/60 py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
          <div className="flex flex-wrap items-center justify-center md:justify-start gap-4">
            <div className="flex items-center gap-2 text-[#B24635] font-medium text-sm sm:text-base font-body">
            ...
            <div className="flex items-center gap-2 text-stone-200 font-medium text-sm sm:text-base font-body">
              <ShieldCheck className="w-4.5 h-4.5 text-[#B24635]" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-10 items-start">
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <p className="text-[#9E9E99] text-xs sm:text-sm leading-relaxed max-w-sm font-body font-normal">
            ...
            <div className="space-y-2.5 pt-1 text-stone-300 text-xs sm:text-sm font-body">
              <div className="flex items-center gap-2.5">
                <Phone className="w-4 h-4 text-[#7A211D] shrink-0" />
              ...
              <div className="flex items-start gap-2 text-[#9E9E99] text-xs sm:text-sm font-body">
                <MapPin className="w-4 h-4 text-[#7A211D] shrink-0 mt-0.5" />
          ...
          <div className="lg:col-span-2 space-y-3">
            <span className="text-xs font-medium text-white uppercase tracking-[0.16em] font-body block">
              Company
            </span>
            <ul className="space-y-2 text-[#9E9E99] text-xs sm:text-sm font-body font-normal">
              <li>
          ...
          <div className="lg:col-span-3 space-y-3">
            ...
            <div className="flex flex-wrap gap-1.5 text-xs text-stone-300 font-body font-normal">
              <span className="px-2.5 py-1 rounded-lg bg-[#1C201F] border border-[#2B302E]">Amravati (HQ)</span>
              <span className="px-2.5 py-1 rounded-lg bg-[#1C201F] border border-[#2B302E]">Nagpur</span>
              <span className="px-2.5 py-1 rounded-lg bg-[#1C201F] border border-[#2B302E]">Chh. Sambhajinagar</span>
              <span className="px-2.5 py-1 rounded-lg bg-[#1C201F] border border-[#2B302E]">Wardha</span>
              <span className="px-2.5 py-1 rounded-lg bg-[#1C201F] border border-[#2B302E]">Akola</span>
              <span className="px-2.5 py-1 rounded-lg bg-[#1C201F] border border-[#2B302E]">Pune</span>
            </div>
