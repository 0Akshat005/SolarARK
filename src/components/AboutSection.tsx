      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-12 relative z-10 space-y-16 sm:space-y-24">
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
            ...
            <div className="bg-emerald-50/70 text-slate-900 rounded-3xl p-8 sm:p-10 shadow-sm space-y-4 border border-emerald-200/90 relative overflow-hidden">
              <div className="w-10 h-10 rounded-xl bg-emerald-100 text-emerald-700 border border-emerald-300 flex items-center justify-center">
                <Leaf className="w-5 h-5" />
              </div>
              <h4 className="font-heading text-2xl font-bold text-[#0B1730]">
                Environmental Responsibility
              </h4>
            ...
            {/* Solar Systems */}
            <div className="bg-red-50/50 text-slate-900 rounded-3xl p-8 sm:p-10 shadow-sm space-y-4 border border-red-200/90 relative overflow-hidden">
              <div className="w-10 h-10 rounded-xl bg-red-100 text-[#8B1E1E] border border-red-200 flex items-center justify-center">
