            ...
            <div className="text-center py-8 space-y-6 flex-1 flex flex-col items-center justify-center animate-fadeIn">
              ...
              <div className="space-y-2 max-w-sm">
                ...
                <p className="text-xs sm:text-sm text-stone-600 leading-relaxed">
                  Thank you, <strong className="text-stone-900">{fullName || 'Valued Customer'}</strong>! Our certified solar engineer is preparing your personalized 3D proposal for pincode{' '}
                  <strong className="text-stone-900 font-mono">{pincode}</strong>.
                </p>
              </div>

              <div className="bg-stone-50 border border-stone-200/80 rounded-2xl p-4 text-left w-full max-w-sm space-y-2 text-xs text-stone-700">
                <div className="flex justify-between">
                  <span className="text-stone-500">Structure:</span>
                  <span className="font-bold capitalize">{roofType} Slab</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-stone-500">Bill Tier:</span>
                  <span className="font-bold">{monthlyBill}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-stone-500">WhatsApp Delivery:</span>
